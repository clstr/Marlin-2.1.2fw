...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_EXTRA_HEIGHT      45     // Extra distance in mm past Z_###_POS to move
  #define GANTRY_CALIBRATION_FEEDRATE         720     // Feedrate for correction move
