...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  16.6667          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  21.8182          // (Hz) The default dominant resonant frequency on the Y axis.
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.0040         // (mm) Compression length applying to all extruders
  #endif
 ...
 */
   ...
   */
    ...
    //#define STEALTHCHOP_E // Disabled for Orbiter v2.0
  #endif
...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_FEEDRATE         750     // Feedrate for correction move
  //#define GANTRY_CALIBRATION_TO_MIN                 // Enable to calibrate Z in the MIN direction

  //#define GANTRY_CALIBRATION_SAFE_POSITION XY_CENTER // Safe position for nozzle
  //#define GANTRY_CALIBRATION_XY_PARK_FEEDRATE 3000  // XY Park Feedrate - MMM
  //#define GANTRY_CALIBRATION_COMMANDS_PRE   ""
  #define GANTRY_CALIBRATION_COMMANDS_POST  "G0 Z200 F7200\nG28"     // G28 highly recommended to ensure an accurate position
#endif
